...
const GIF_LOADING = 'https://media1.tenor.com/m/EQLp7bbM_7gAAAAC/kizaru-smile-one-piece.gif';
...
async function startQuizNow() {
    ...
    try {
        ...
        if (response.ok && result.success && result.data.length > 0) {
            ...
            throw new Error(result.error || 'Chưa có câu hỏi nào trong cơ sở dữ liệu.');
        }
    } catch (err) {
